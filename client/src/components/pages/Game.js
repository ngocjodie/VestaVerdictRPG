...
window.printcurrentConvo = function(){
  var answers = "";
  for(var i=0,l=dialogueSystem[currentConvo].answers.length;i<l;i++){
      answers += "<p><button class='Game-choices butt' onclick='setConvo("+dialogueSystem[currentConvo].answers[i].response+")'>"+dialogueSystem[currentConvo].answers[i].title+"</button></p>";
      // <p><button class='choices' onclick='setConvo(dialogueSystem[currentConvo].answers[i].response)'>dialogueSystem[currentConvo].answers[i].title</button></p>
  }
  document.getElementById("answers").innerHTML = answers;
}
...
if (document.getElementById('boxImage').classList.contains("Game-hidden") && document.getElementById('question').classList.contains("Game-hidden") & document.getElementById('answers').classList.contains("Game-hidden")) {
  allHidden = true;
}
...
document.body.onkeyup = function(e) {
  ...
  if (e.keyCode == 32 && clicky == 0 && ending.includes(currentConvo) && allHidden) {
      ...
      if (ending.includes(currentConvo)) {
          // alert(currentConvo);
          // alert('ending');
          document.getElementById('boxImage').classList.toggle('Game-hidden');
      }
      ...
      setTimeout(function(){
          document.getElementById('question').classList.toggle("Game-hidden");
      }, speed);
      ...
      var consoleTyper = setInterval(function () {
          ...
          else
          {
              ...
              document.getElementById('answers').classList.toggle("Game-hidden");
          }}, speed);
  }
